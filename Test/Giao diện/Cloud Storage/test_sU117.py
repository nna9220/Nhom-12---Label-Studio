...
class TestSU117():
  ...
  def test_sU117(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ls-projects-page__link:nth-child(5) .ls-project-card__title svg").click()
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'Google Cloud Storage']").click()
    self.driver.find_element(By.NAME, "title").click()
    self.driver.find_element(By.NAME, "title").send_keys("demo3_12")
