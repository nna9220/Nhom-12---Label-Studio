...
class TestSU119():
  ...
  def test_sU119(self):
    ...
    element = self.driver.find_element(By.LINK_TEXT, "Instructions")
    ...
    self.driver.find_element(By.NAME, "port").click()
    self.driver.find_element(By.NAME, "port").send_keys("8080")
