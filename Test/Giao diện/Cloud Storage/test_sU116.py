...
class TestSU116():
  ...
  def test_sU116(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ls-projects-page__link:nth-child(1) .ls-project-card__title path").click()
    ...
    self.driver.find_element(By.NAME, "title").send_keys("demo_trang")
