...
class TestSU1110():
  ...
  def test_sU1110(self):
    self.driver.get("http://localhost:8081/projects/?page=1")
    self.driver.set_window_size(1120, 680)
    self.driver.find_element(By.CSS_SELECTOR, ".ls-projects-page__link:nth-child(6) .ls-project-card__title svg").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ls-columns__item:nth-child(2) .ls-button").click()
    ...
    self.driver.find_element(By.NAME, "path").send_keys("D:\\CCVMTPTPM")
    ...
    element = self.driver.find_element(By.CSS_SELECTOR, ".ls-button_type_submit")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
