...
class TestSU143():
  ...
  def test_sU143(self):
    ...
    self.driver.find_element(By.NAME, "email").send_keys("nanguyen@gmail.com")
    ...
    dropdown.find_element(By.XPATH, "//option[. = 'annotator']").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ls-people-list__user:nth-child(10)").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".ls-people-list__user:nth-child(10) > .ls-email_iv").text == "nanguyen@gmail.com"
