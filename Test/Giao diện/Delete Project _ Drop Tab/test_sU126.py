...
class TestSU126():
  ...
  def test_sU126(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ls-projects-page__link:nth-child(1) .ls-project-card__title").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "li:nth-child(4) > .dm-menu__item_look_danger").click()
