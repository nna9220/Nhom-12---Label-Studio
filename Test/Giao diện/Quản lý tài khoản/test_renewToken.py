...
#Thêm std
driver.find_element(By.NAME, "renew").click()
new = driver.find_element(By.ID,"access_token")

value = driver.find_element(By.CSS_SELECTOR, "[name='access_token']").get_attribute("value")
assert value == new
