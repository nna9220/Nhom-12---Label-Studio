...
class TestSU95():
  ...
  def test_sU95(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ls-projects-page__link:nth-child(6) .ls-project-card__title path").click()
    self.driver.find_element(By.LINK_TEXT, "Settings").click()
    self.driver.find_element(By.CSS_SELECTOR, ".ls-radio-group__button:nth-child(2) .ls-label__field").click()
