...
class TestSU45():
  ...
  def test_sU45(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ls-toggle-items__item:nth-child(3)").click()
    self.driver.find_element(By.CSS_SELECTOR, ".ls-templates-list__template:nth-child(5) > img").click()
